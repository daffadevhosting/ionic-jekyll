...
var cart_kosong = '<div class="empty-cart" style="margin-bottom: 12px;display: flex;flex-wrap: wrap;flex-direction: column;align-items: center;"><ion-icon name="bag-outline" style="font-size: 95px;"></ion-icon><p class="center">Keranjang Belanja masih kosong</p></div>';
