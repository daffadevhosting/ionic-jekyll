...
const index$1 = require('./index-e8e84432.js');
const index$2 = require('./index-92f1bbf7.js');
...
const overlays = require('./overlays-7825e83a.js');
...
const Datetime = class {
  ...
  valueChanged() {
    if (this.hasValue()) {
      ...
      if (valueDateParts) {
        ...
        index.printIonWarning(`Unable to parse date string: ${this.value}. Please provide a valid ISO 8601 datetime string.`);
      }
    }
    this.emitStyle();
    this.ionChange.emit({
  ...
  renderYearView() {
    ...
    return (index$1.h("div", { class: "datetime-year" }, index$1.h("div", { class: {
        'datetime-year-body': true,
        [`order-${columnOrder}`]: true,
      } }, index$1.h("ion-picker-internal", null, showMonth && (index$1.h("ion-picker-column-internal", { class: "month-column", color: this.color, items: months, value: workingParts.month, onIonChange: (ev) => {
        ...
        this.initializeCalendarIOListeners();
        ev.stopPropagation();
      } })), showYear && (index$1.h("ion-picker-column-internal", { class: "year-column", color: this.color, items: years, value: workingParts.year, onIonChange: (ev) => {
        // Due to a Safari 14 issue we need to destroy
        // the intersection observer before we update state
        // and trigger a re-render.
        if (this.destroyCalendarIO) {
  ...
  renderCalendarHeader(mode) {
    ...
    return (index$1.h("div", { class: "calendar-header" }, index$1.h("div", { class: "calendar-action-buttons" }, index$1.h("div", { class: "calendar-month-year" }, index$1.h("ion-item", { button: true, detail: false, lines: "none", onClick: () => this.toggleMonthAndYearView() }, index$1.h("ion-label", null, getMonthAndYear(this.locale, this.workingParts), ' ', index$1.h("ion-icon", { icon: this.showMonthAndYear ? expandedIcon : collapsedIcon, lazy: false })))), index$1.h("div", { class: "calendar-next-prev" }, index$1.h("ion-buttons", null, index$1.h("ion-button", { disabled: prevMonthDisabled, onClick: () => this.prevMonth() }, index$1.h("ion-icon", { slot: "icon-only", icon: index$2.chevronBack, lazy: false, flipRtl: true })), index$1.h("ion-button", { disabled: nextMonthDisabled, onClick: () => this.nextMonth() }, index$1.h("ion-icon", { slot: "icon-only", icon: index$2.chevronForward, lazy: false, flipRtl: true }))))), index$1.h("div", { class: "calendar-days-of-week" }, getDaysOfWeek(this.locale, mode, this.firstDayOfWeek % 7).map((d) => {
  ...
  renderMonth(month, year) {
    ...
    return (index$1.h("div", { class: {
      ...
      } }, index$1.h("div", { class: "calendar-month-grid" }, getDaysOfMonth(month, year, this.firstDayOfWeek % 7).map((dateObject, index$2) => {
  ...
  renderCalendarBody() {
    return (index$1.h("div", { class: "calendar-body ion-focusable", ref: (el) => (this.calendarBodyRef = el), tabindex: "0" }, generateMonths(this.workingParts).map(({ month, year }) => {
      return this.renderMonth(month, year);
    })));
  }
  renderCalendar(mode) {
    return (index$1.h("div", { class: "datetime-calendar" }, this.renderCalendarHeader(mode), this.renderCalendarBody()));
  }
  renderTimeLabel() {
  ...
  renderTimePicker(hoursItems, minutesItems, ampmItems, use24Hour) {
    ...
    return (index$1.h("ion-picker-internal", null, index$1.h("ion-picker-column-internal", { color: color, value: activePartsClone.hour, items: hoursItems, numericInput: true, onIonChange: (ev) => {
        this.setWorkingParts(Object.assign(Object.assign({}, workingParts), { hour: ev.detail.value }));
        this.setActiveParts(Object.assign(Object.assign({}, activePartsClone), { hour: ev.detail.value }));
        ev.stopPropagation();
      } }), index$1.h("ion-picker-column-internal", { color: color, value: activePartsClone.minute, items: minutesItems, numericInput: true, onIonChange: (ev) => {
        this.setWorkingParts(Object.assign(Object.assign({}, workingParts), { minute: ev.detail.value }));
        this.setActiveParts(Object.assign(Object.assign({}, activePartsClone), { minute: ev.detail.value }));
        ev.stopPropagation();
      } }), !use24Hour && (index$1.h("ion-picker-column-internal", { color: color, value: activePartsClone.ampm, items: ampmItems, onIonChange: (ev) => {
  ...
  renderTime() {
    ...
    return (index$1.h("div", { class: "datetime-time" }, timeOnlyPresentation
  ...
  renderCalendarViewHeader(mode) {
    ...
    return (index$1.h("div", { class: "datetime-header" }, index$1.h("div", { class: "datetime-title" }, index$1.h("slot", { name: "title" }, "Select Date")), mode === 'md' && index$1.h("div", { class: "datetime-selected-date" }, getMonthAndDay(this.locale, this.activeParts))));
  }
  renderDatetime(mode) {
    const { presentation } = this;
    switch (presentation) {
