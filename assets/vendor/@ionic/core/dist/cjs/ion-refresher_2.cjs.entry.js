...
const index$3 = require('./index-92f1bbf7.js');
...
const Refresher = class {
  ...
  async connectedCallback() {
     ...
     * element and styles.
     */
    this.backgroundContentEl = helpers.getElementRoot(contentEl !== null && contentEl !== void 0 ? contentEl : customScrollTarget).querySelector('#background-content');
